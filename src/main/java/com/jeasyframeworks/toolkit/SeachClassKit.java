...
public class SeachClassKit {

    protected static final Logger LOG = Logger.getLogger(SeachClassKit.class);
    ...
    public static SeachClassKit of(Class<?> target) {
        return new SeachClassKit(target);
    }
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                if (file.isDirectory()) {
                    ...
                    if (wildcardMatch(targetFileName, file.getName())) {
                        ...
                        //String open = PathKit.getWebRootPath() + File.separator + "WEB-INF" + File.separator + "classes" + File.separator;
    ...
    public SeachClassKit(Class<?> target) {
        this.target = target;
    }

    public SeachClassKit injars(List<String> jars) {
        if (jars != null) {
    ...
    public SeachClassKit inJars(String... jars) {
        if (jars != null) {
            for (String jar : jars) {
                includeJars.add(jar);
            }
    ...
    public SeachClassKit includeAllJarsInLib(boolean includeAllJarsInLib) {
        this.includeAllJarsInLib = includeAllJarsInLib;
        return this;
    }

    public SeachClassKit classpath(String classpath) {
        this.classpath = classpath;
        return this;
    }

    public SeachClassKit libDir(String libDir) {
        this.libDir = libDir;
        return this;
    }

    public SeachClassKit scanPackages(List<String> scanPaths) {
        if (scanPaths != null) {
