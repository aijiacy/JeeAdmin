 ...
 */
package com.jeasyframeworks.extentions.captcha.filter.predefined;

import java.awt.image.BufferedImageOp;
import java.util.ArrayList;
import java.util.List;

import com.jeasyframeworks.extentions.captcha.filter.AbstractFilterFactory;
import com.jeasyframeworks.extentions.captcha.filter.library.DoubleRippleImageOp;
